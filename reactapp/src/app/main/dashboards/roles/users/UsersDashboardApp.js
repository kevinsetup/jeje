...
const UserTable = ({ handleOpenEditUser }, props) => {
  ...
  const fetchUsers = async () => {
    try {
      const apiUrl = environment.apiUrl + "Usuario/GetUsuarios";
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <StyledTableRow key={user.idUsuario}>
              ...
              <StyledTableCell>{user.tipoUsuario}</StyledTableCell>
              <StyledTableCell>{user.estado}</StyledTableCell>
              <StyledTableCell>
                <Button
